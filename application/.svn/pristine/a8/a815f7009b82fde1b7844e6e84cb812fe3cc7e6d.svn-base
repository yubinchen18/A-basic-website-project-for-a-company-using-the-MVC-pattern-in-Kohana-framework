...
Kohana::modules(array_merge(array(
		...
		// frontend application library module
		'library_frontend'	=> LIBRARYPATH.'frontend',
		...
		'mailchimp' => VENDORPATH.'mailchimp'
	),
	APPLICATION_ENV === 'develop' ? array('manager'=> LIBRARYPATH.'manager') : array()
));
